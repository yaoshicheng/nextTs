...
import DAppContainer from '../../src/containers/dApp';
...
class DAppPage extends React.PureComponent<Props, State> {
  ...
  render(): React.ReactNode {
    ...
    return (
      ...
      >
        <>
          <FormattedMessage id="MENU_01005" description="DApp">
