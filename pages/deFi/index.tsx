...
import DeFiConatiner from '../../src/containers/deFi';
...
class DeFiPage extends React.PureComponent<Props, State> {
  ...
  render(): React.ReactNode {
    ...
    return (
      ...
      >
        <>
          <FormattedMessage id="MENU_01004" description="Defi">
